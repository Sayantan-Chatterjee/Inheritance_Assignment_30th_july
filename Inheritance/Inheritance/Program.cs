...
namespace Inheritance
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            d.ShowCricketDetails("India", 11, "John Wright");
            d.ShowCricketDetails("Australia", 11, "John Buchanan");
            Console.WriteLine();
            Console.WriteLine();

            Console.WriteLine("-----------------FootBall Information----------------------");
            d.ShowFootBallDetails("Spain", 14, "Spainish League");
            d.ShowFootBallDetails("England", 13, "English Premiur League");
            Console.WriteLine();
            Console.WriteLine();
            Console.WriteLine();
